...
//===----------------------------------------------------------------------===//
// The date parsers: civil arithmetic, ISO-8601, unix timestamps, RFC 9110 and fixed
// patterns. Pure functions from bytes to epoch seconds; nothing here touches a reader.
// The design argument — why these are arithmetic and not Foundation — is at the top of
// DateFormat.swift. Split out of Dates.swift on 2026-09-10.
//===----------------------------------------------------------------------===//
