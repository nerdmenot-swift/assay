...
struct EncodingTests {
    ...
    func stable() throws {
        ...
        #expect(try Array(v.encodedJSON()) == Array(v.encodedJSON()))
    ...
    func targetsInput() throws {
        ...
        #expect(try EncTransformed.parse(json: Array(v.encodedJSON())) == v)
    }
    ...
    func defaultsEmitted() throws {
        ...
        #expect(try EncPayload.parse(json: Array(v.encodedJSON())) == v)
    }
    ...
    func extrasRoundTrip() throws {
        ...
        let again = try EncOpen.parse(json: Array(v.encodedJSON()))
    ...
    func fallbackWritesValue() throws {
        ...
        let again = EncFallback.diagnose(json: try Array(v.encodedJSON()))
    ...
    func oddKeysRoundTrip() throws {
        let v = EncOddKeys(quote: 1, slash: 2, tab: 3)
        #expect(try EncOddKeys.parse(json: try Array(v.encodedJSON())) == v)
    }
