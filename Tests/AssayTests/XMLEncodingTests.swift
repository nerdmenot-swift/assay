...
struct XMLEncodingTests {
    ...
    func textPlacement() throws {
        ...
        #expect(try XText.parse(xml: Array(v.encodedXML())) == v)
    }
    ...
    func escaping() throws {
        ...
        let again = try XText.parse(xml: Array(v.encodedXML()))
    ...
    func rootName() throws {
        ...
        #expect(try XText.parse(xml: Array(v.encodedXML(root: "message"))) == v)
    }
